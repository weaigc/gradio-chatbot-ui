...
const HistoryContent: FC<{ botName: string; keyword: string }> = ({ botName, keyword }) => {
  const historyQuery = useSWR(`history:${botName}`, () => loadHistoryMessages(botName), { suspense: true })
